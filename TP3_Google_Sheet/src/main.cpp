...
String GOOGLE_SCRIPT_ID = "AKfycbwKh5obUk1L2622iPSH8M4mQfz_9tE0aKM4vqpvIT9-MVfikzSEkGMUZBdDkQYUqELdDg";
...
void loop() {
  ...
  if ((millis() - lastTime) > timerDelay && digitalRead(Bp1)==1) {
    ...
    if(WiFi.status()== WL_CONNECTED){
      strParameter = "temperature=" + strTemp + "&humidity=" + strHum + "&Luminosite=" + value ;
